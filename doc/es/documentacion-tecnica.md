...
## AWS Desktop Center — Arquitectura y Referencia Técnica
...
│   └── aws-desktop-center.exe  # Binario precompilado (Windows x86_64)
└── doc/
...
```bash
cargo build --release
# Binario: target/release/aws-desktop-center (Linux) o aws-desktop-center.exe (Windows)
```
